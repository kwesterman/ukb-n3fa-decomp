...
n3fa_impute_df$n3fa_ffq <- predict(n3fa_impute_lm_fit, newdata = n3fa_impute_df)
phenos$n3fa_ffq <- n3fa_impute_df$n3fa_ffq

more_lm_res_df <- expand_grid(
  dv = c("oily_fish", "fish_oil_touchscreen", "n3fa_ffq"),
...
n3fa_variables <- c(n3fa_variables, "n3fa_ffq")
n3fa_variables_clean <- c(n3fa_variables_clean, "Estimated N3FA - FFQ")
...
```{r nmr-mediation, cache = 1, eval = F}
...
n3fa_ffq_med_obj <- test_mediation(
  "n3fa_ffq", "Omega_3_pct", "hscrp_log", all_covars, phenos
)
summary(n3fa_ffq_med_obj)
...
med_design_df <- expand_grid(
  e = c("oily_fish", "fish_oil_touchscreen", "n3fa_ffq"),
  m = c("Omega_3_pct", "DHA_pct", "nonDHA_pct"),
  y = c("hscrp_log", "tg_log", "ldl_statinadj")
)
...
gwis_variables <- c("id", 
                    gwis_bms, 
                    c(n3fa_variables, "fish_oil", "n3fa_ffq"), 
                    pufa_metabolites, 
